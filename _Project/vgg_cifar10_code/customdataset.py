...
class CustomImageDataset(Dataset):
    ...
    def read_data_set(self):
        ...
        # temp_class_name = ['normal', 'adenocarcinoma', 'cd', 'uc', 'adenoma']
        # classe_names: ['bird', 'airplane', 'dog', 'cat', 'ship', 'frog', 'automobile', 'truck', 'deer', 'horse'] 210417 the class' order of cifar10 dataset
        temp_class_name = ['bird', 'airplane', 'dog', 'cat', 'ship', 'frog', 'automobile', 'truck', 'deer', 'horse']
