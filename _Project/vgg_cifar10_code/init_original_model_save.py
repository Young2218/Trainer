...
def main():
    ...
    train_data_set = CustomImageDataset(data_set_path="/media/softuser/D/HC_data/cifar10/train",
    ...
    torch.save(hidden_model.state_dict(),f'./weights/init_weight_original_210525_({m_name[model_number]})_cifar10.pth')
